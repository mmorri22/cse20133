...
void* thread_func( void* inputs ){
	...
	while(   ){
		...
		if(  ){
			...
			std::cout << "Kid " << func_inputs->kid_id << " ate" << num_slices << " slices ";
			std::cout << "and has eaten " << func_inputs->curr_slices << ". ";
			std::cout << "There are " << *(func_inputs->pizza_ptr) << " total slices remaining." << std::endl;
		 ...
		 */
			...
			// Print the information to the user
			std::cout << "Kid " << func_inputs->kid_id << " ate 1 silce";
			std::cout << " and has eaten " << func_inputs->curr_slices << ". ";
			std::cout << "There are " << *(func_inputs->pizza_ptr) << " total slices remaining." << std::endl;
...
int main( void ){
	...
	std::cout << "Initial Pizza Slices = " << pizza_slices;
	std::cout << " for " << num_kids << " kids" << std::endl;
